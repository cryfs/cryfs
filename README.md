...
------------
  ...
  - libFUSE version >= 3.9 (including development headers), on macOS instead install macFUSE 4.10.0 or newer from https://osxfuse.github.io/ - that is the first macFUSE release that ships libFUSE 3
  - Python >= 3.5
  - OpenMP
