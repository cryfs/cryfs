...
// NOLINTNEXTLINE(cppcoreguidelines-avoid-const-or-ref-data-members) - the members are generated by the MATCHER_P2 macro
...
public:
  ...
  void ReturnFileWithKnownTimestampsOnLstat(const char *filename) {
    EXPECT_CALL(*fsimpl, lstat(Eq(filename), ::testing::_)).WillRepeatedly(Invoke([] (const boost::filesystem::path&, fspp::fuse::STAT *result) {
