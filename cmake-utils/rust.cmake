...
function(target_add_rust_companion TARGET_NAME)
    ...
    if(TARGET_WANTS_LTO)
        if ("${CMAKE_CXX_COMPILER_ID}" STREQUAL "Clang" OR "${CMAKE_CXX_COMPILER_ID}" STREQUAL "AppleClang")
            ...
            if ("${_CMAKE_CXX_COMPILER_VERSION_MAJOR}" GREATER_EQUAL 9)
                ...
                target_link_libraries("${TARGET_NAME}_rustcompanion" PUBLIC "-fuse-ld=lld")
    ...
    target_link_libraries("${TARGET_NAME}_rustcompanion" PUBLIC pthread dl "${CMAKE_CURRENT_BINARY_DIR}/${ARGS_RUST_DIR}/${TARGET_DIR}/${ARGS_RUST_LIB_NAME}")
