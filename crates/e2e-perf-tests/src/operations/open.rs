...
crate::perf_test_macro::perf_test!(open, [in_rootdir, in_nesteddir, in_deeplynesteddir,]);

fn in_rootdir(test_driver: impl TestDriver) -> impl TestReady {
    test_driver
        .create_filesystem()
        .setup(async |fixture| {
            fixture
        ...
        .test(async |fixture, file| {
            fixture.filesystem.open(file).await.unwrap();
        })
...
fn in_nesteddir(test_driver: impl TestDriver) -> impl TestReady {
    test_driver
        .create_filesystem()
        .setup(async |fixture| {
            let parent = fixture
...
fn in_deeplynesteddir(test_driver: impl TestDriver) -> impl TestReady {
    test_driver
        .create_filesystem()
        .setup(async |fixture| {
            let parent = fixture
