...
async fn chown_file_in_rootdir(
    ...
    let counts = fixture
        .count_ops(async |fs| {
            fs.chown(Some(file), Some(Uid::from(1000)), Some(Gid::from(1000)))
                .await
                .unwrap();
        })
        .await;
...
async fn chown_dir_in_rootdir(
    ...
    let counts = fixture
        .count_ops(async |fs| {
            fs.chown(Some(dir), Some(Uid::from(1000)), Some(Gid::from(1000)))
                .await
                .unwrap();
        })
        .await;
...
#[rstest]
#[tokio::test(flavor = "multi_thread")]
async fn chown_symlink_in_rootdir(
    fixture_factory: impl FixtureFactory,
    atime_behavior: AtimeUpdateBehavior,
) {
    let fixture = fixture_factory.create_filesystem(atime_behavior).await;
    ...
    let counts = fixture
        .count_ops(async |fs| {
            fs.chown(Some(symlink), Some(Uid::from(1000)), Some(Gid::from(1000)))
                .await
                .unwrap();
        })
        .await;
...
#[rstest]
#[tokio::test(flavor = "multi_thread")]
async fn chown_file_in_nesteddir(
    fixture_factory: impl FixtureFactory,
    atime_behavior: AtimeUpdateBehavior,
) {
    let fixture = fixture_factory.create_filesystem(atime_behavior).await;
...
#[rstest]
#[tokio::test(flavor = "multi_thread")]
async fn chown_file_in_deeplynesteddir(
    fixture_factory: impl FixtureFactory,
    atime_behavior: AtimeUpdateBehavior,
) {
    let fixture = fixture_factory.create_filesystem(atime_behavior).await;
