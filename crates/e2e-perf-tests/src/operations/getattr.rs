        ...
        .expect_op_counts(|fixture_type, _atime_behavior| ActionCounts {
            ...
            high_level: HLActionCounts {
                ...
                blob_data: match fixture_type {
                    ...
                    FixtureType::FuserWithoutInodeCache => 41, // TODO Why more than fusemt? Maybe because our CryNode structs don't cache the node and only store the path, so we have to lookup for fuser and then lookup everythin again?
                },
                ..HLActionCounts::ZERO
            },
            low_level: LLActionCounts {
        ...
        .expect_op_counts(|fixture_type, _atime_behavior| ActionCounts {
            ...
            high_level: HLActionCounts {
                ...
                blob_data: match fixture_type {
                    ...
                    FixtureType::FuserWithoutInodeCache => 77, // TODO Why more than fusemt? Maybe because our CryNode structs don't cache the node and only store the path, so we have to lookup for fuser and then lookup everythin again?
                },
                ..HLActionCounts::ZERO
            },
            low_level: LLActionCounts {
