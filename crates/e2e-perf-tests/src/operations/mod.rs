...
// TODO Test other operations: setattr/fsetattr (chmod/fchmod, chown/fchown, chgrp/fchgrp, truncate/ftruncate, utimens, futimens), unlink, rmdir, rename, open, read, write, flush, fsync, readdir, statfs
