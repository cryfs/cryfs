...
criterion::criterion_main!(
    ...
    cryfs_e2e_perf_tests::operations::release::benches_release,
    ...
    cryfs_e2e_perf_tests::operations::statfs::benches_statfs,
    ...
    cryfs_e2e_perf_tests::operations::write::benches_write,
);
