...
//! ## XChaCha20-Poly1305
//!
//! - [`XChaCha20Poly1305`]: Modern cipher with 192-bit nonce (recommended for most use cases)
//!
//! ## AES-GCM (Advanced Encryption Standard in Galois/Counter Mode)
//!
//! - [`Aes256Gcm`]: 256-bit AES-GCM (faster than XChaCha20Poly1305 and still secure)
//! - [`Aes128Gcm`]: 128-bit AES-GCM (not recommended)
//!
...
//! # Ciphertext Format
//!
//! All ciphertexts combine nonce, ciphertext and authentication tag into one byte array,
//! so call sites don't have to know about these separate components.
//!
//! # Example
//!
//! ```
...
pub trait Cipher {
    ...
    /// # Returns
    ///
    /// The ciphertext, including nonce, encrypted data, and authentication tag
    ///
    /// # Errors
    ///
