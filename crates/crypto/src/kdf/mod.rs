...
/// # Associated Types
///
/// - `Settings`: Configuration for generating new parameters (e.g., memory cost)
/// - `Parameters`: The actual parameters used for key derivation (includes salt)
///
/// # Security
///
...
pub trait PasswordBasedKDF {
    /// Configuration settings for generating new parameters.
    type Settings;
    /// The parameters used during key derivation.
