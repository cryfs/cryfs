...
mod tests {
    ...
    mod fake_http_client {
        ...
        fn no_websites_known() {
            ...
            assert_eq!(
                ...
                client
                    .get("https://example.com", Duration::from_secs(60))
                    .unwrap_err()
                    .to_string()
            );
        }
        ...
        fn unknown_website() {
            ...
            assert_eq!(
                ...
                client
                    .get("https://notexisting.com", Duration::from_secs(60))
                    .unwrap_err()
                    .to_string()
            );
        }
        ...
        fn two_websites_existing() {
            ...
            assert_eq!(
                client
                    .get("https://first.com", Duration::from_secs(60))
                    .unwrap(),
                "First website"
            );
            assert_eq!(
                client
                    .get("https://second.com", Duration::from_secs(60))
                    .unwrap(),
                "Second website"
            );
            assert_eq!(
        ...
        fn overwriting() {
            ...
            assert_eq!(
                client
                    .get("http://existing.com", Duration::from_secs(60))
                    .unwrap(),
                "new_content"
            );
        }
        ...
        fn request_counter() {
            ...
            client
                .get("http://example.com", Duration::from_secs(60))
                .unwrap_err();
    ...
    mod reqwest_http_client {
        ...
        fn test_get_invalid_protocol() {
            ...
            assert!(
                client
                    .get("invalid://example.com", Duration::from_secs(60))
                    .is_err()
            );
        }
        ...
        fn test_get_invalid_tld() {
            ...
            assert!(
                client
                    .get("http://example.invalidtld", Duration::from_secs(60))
                    .is_err()
            );
        }
