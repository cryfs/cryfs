...
#include <cryptopp-vendor/aes.h>
#include <cryptopp-vendor/twofish.h>
#include <cryptopp-vendor/serpent.h>
#include <cryptopp-vendor/cast.h>
#include <cryptopp-vendor/mars.h>
#include <cryptopp-vendor/chachapoly.h>
