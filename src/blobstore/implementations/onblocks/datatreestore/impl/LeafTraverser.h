...
namespace blobstore {
    namespace onblocks {
        ...
        namespace datatreestore {
            ...
            public:
                LeafTraverser(datanodestore::DataNodeStore *nodeStore, cpputils::ThreadPool *threadPool);
            ...
            private:
                ...
                std::vector<std::future<void>> _waitHandles;
                ...
                void _addTask(std::packaged_task<void ()> task);
                void _waitForAllCallbacksFinished();
