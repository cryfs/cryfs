...
macro_rules! _instantiate_highlevel_blockstore_tests {
    ...
    (@module_impl $module_name: ident, $target: ty, $tokio_test_args: tt, $flush_cache_on_yield: expr, $head_test_case: ident $(, $tail_test_cases: ident)*) => {
        ...
        async fn $head_test_case() {
            ...
            $crate::tests::high_level::$module_name::$head_test_case(fixture).await;
        }
...
macro_rules! instantiate_highlevel_blockstore_tests {
    ...
    ($target: ty, $tokio_test_args: tt) => {
        ...
        mod low_level_adapter {
            ...
            mod without_flushing {
                use super::*;
                $crate::instantiate_lowlevel_blockstore_tests!($crate::tests::high_level::TestFixtureAdapter<$target, false>, $tokio_test_args);
            }
            mod with_flushing {
                use super::*;
                $crate::instantiate_lowlevel_blockstore_tests!($crate::tests::high_level::TestFixtureAdapter<$target, true>, $tokio_test_args);
            }
        }
