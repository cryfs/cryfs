...
pub type Aes256GcmHardwareAccelerated = libsodium::Aes256Gcm;
pub type Aes256GcmSoftwareImplemented = super::aead_crate_wrapper::AeadCipher<aes_gcm::Aes256Gcm>;
...
enum Aes256GcmImpl {
    HardwareAccelerated(Aes256GcmHardwareAccelerated),
    SoftwareImplementation(Aes256GcmSoftwareImplemented),
}
