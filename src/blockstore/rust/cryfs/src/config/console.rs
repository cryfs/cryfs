...
pub trait Console {
    ...
    fn ask_allow_replaced_filesystem(&self) -> bool;
    ...
    fn ask_disable_single_client_mode(&self) -> bool;
    ...
    fn ask_single_client_mode_for_new_filesystem(&self) -> bool;

    /// We're in the process of creating a new file system and need to ask the user for the scrypt settings to use
    fn ask_scrypt_settings_for_new_filesystem(&self) -> ScryptSettings;
