...
namespace cryfs_cli {
    ...
    private:
        using Console = cpputils::Console;
        ...
        static std::function<std::string()> _askPasswordForExistingFilesystem(std::shared_ptr<Console> console);
        static std::function<std::string()> _askPasswordForNewFilesystem(std::shared_ptr<Console> console);
        static std::function<std::string()> _askPasswordNoninteractive(std::shared_ptr<Console> console);
        ...
        static void _checkDirReadable(const boost::filesystem::path &dir, const cpputils::TempFile &tempfile, const std::string &name, cryfs::ErrorCode errorCode);
